...
<form runat="server" id="form1" style="width:100%;height:100%;">
        ...
        <div id="master-left">
            <div class="master-list-manage">
                ...
                <div class="list-manage">
                    <a href="Master_Order.html" class="a1 active" target="detail">我的订单</a>
                    <a href="${pageContext.request.contextPath}/public/newPage/follow.html" class="a1" target="detail">我的关注</a>
                    <a href="${pageContext.request.contextPath}/public/newPage/accountManagement.html" class="a1" target="detail">账户管理</a>
                    <a href="${pageContext.request.contextPath}/public/newPage/Blacklist.html" class="a1" target="detail">黑名单管理</a>
                    <a href="${pageContext.request.contextPath}/public/page/giftsss.jsp" class="a1" target="detail">礼物记录</a>
                </div>
            </div>
            <div class="master-list-set">
                <div class="master-set">
                    <span class="glyphicon glyphicon-cog master-set-icon"></span>
                    <span class="master-set-name">设置</span>
                </div>
                <div class="list-set">
                    <a href="${pageContext.request.contextPath}/public/newPage/safe.html" class="a1" target="detail">安全中心</a>
                    <a href="${pageContext.request.contextPath}/public/newPage/personal.html" class="a1" target="detail">个人资料</a>
                    <a href="${pageContext.request.contextPath}/public/newPage/tutor.jsp" class="a1" target="detail">申请入驻</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="height:2990px;margin:auto auto auto 180px;">
        <iframe id="detail" name="detail" style="margin:0;padding:0;height:100%;width:100%;right:0;border:solid 0 red;" src="Master_Order.html" frameborder="0" ></iframe>
    </div>
</form>
</body>
<script>
